...
```{r, fig1, echo= FALSE, fig.align='center', fig.cap="The spatial domain of the reanalysis dataset."}
...
```{r, fig2, fig.align='center', fig.cap= "Processing the shapefile and downloading relevant grid points.", echo=FALSE}
