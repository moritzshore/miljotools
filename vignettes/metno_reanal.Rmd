...
[Last Update]{.underline}: October, 2025
...
Please note! `metnordic_download()` and `metnordic_download_daterange()` do not
work for point geometries. You're meant to extract from downloaded .nc files
using point locations. But, if you really don't want to do that, you can use the
