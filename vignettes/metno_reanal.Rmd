...
data <- brick(agg_path)
spatast <- data  %>% rast()
plot(spatast, main = "air_temperature_2m_mean \n(2019-06-01)")
```
...
files <- c("cs10_basin.zip", "cs10_txt.zip", "cs10point.zip", "metnordic.met", "reprojected_example.nc", "cwatm_ready.nc", "parlog.log")
