...
There are two main ways of downloading the data, either as seperate .csv
files for each grid point, or NetCDF "maps" that cover a certain extent.
...
downloading, or to download the files in NetCDF format.
