---
title: "ERA5 for SWAT Plus"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{ERA5 for SWAT Plus}
...
following template [EXACTLY]{.underline}, only changing the grid cells
(list format), start and end date, and perhaps the variables (*UNTESTED
– make sure to adjust the `open_meteo_variables`* parameter). Any
