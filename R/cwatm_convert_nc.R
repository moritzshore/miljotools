...
#
#
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "grid_mapping_name", attval = "transverse_mercartor")
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "utm_zone_number", attval = 33)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "proj4", attval = "+proj=utm +zone=33 +datum=WGS84 +units=m +no_defs +type=crs")
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "false_easting", attval = 5e+05)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "false_northing", attval = 0)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "scale_factor_at_central_meridian", attval =0.9996)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "longitude_of_projection_origin", attval = 0)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "latitude_of_projection_origin", attval = 15)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "semi_major_axis", attval = 6378137)
#   ncatt_put(nc = testing, varid = "UTM_Zone_33",attname = "inverse_flattening", attval = 298.257222101)
#
# ncatt_put(nc = testing, varid = "x" ,attname = "standard_name", attval = "x coordinate of projection")
# ncatt_put(nc = testing, varid = "x" ,attname = "long_name", attval = "x coordinate of projection")
#
# ncatt_put(nc = testing, varid = "y" ,attname = "standard_name", attval = "y coordinate of projection")
# ncatt_put(nc = testing, varid = "y" ,attname = "long_name", attval = "y coordinate of projection")
#
#
# conventions <- ncatt_get(to_reform, 0, "Conventions")
# created_by <- ncatt_get(to_reform, 0, "created_by")
# date <- ncatt_get(to_reform, 0, "date")
# institution <- ncatt_get(to_reform, 0, "institution")
# history <- ncatt_get(to_reform, 0, "history")
# ncatt_put(nc = testing, varid = 0 ,attname = "history", attval = "temp")
# ncatt_put(nc = testing, varid = 0 ,attname = "source_software", attval = "temp")
# ncatt_put(nc = testing, varid = 0 ,attname = "keywords", attval = "temp")
# ncatt_put(nc = testing, varid = 0 ,attname = "source", attval = "temp")
# ncatt_put(nc = testing, varid = 0 ,attname = "institution", attval = "temp")
# ncatt_put(nc = testing, varid = 0 ,attname = "description", attval = "temp")
#
